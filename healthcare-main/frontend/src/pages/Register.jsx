...
export default function Register() {
    ...
    return (
      <div style={{
        ...
        >
          ...
          <p style={{ fontSize: '13px', color: t.textMuted, marginBottom: '32px', lineHeight: 1.5 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            >
              ...
              <div>
                <p style={{ fontSize: '15px', fontWeight: '700', color: t.text, marginBottom: '3px' }}>
                  I'm a Patient
                </p>
                <p style={{ fontSize: '12px', color: t.textMuted, lineHeight: 1.4 }}>
                  Access health dashboard, chat with AI doctor, book appointments
                </p>
              </div>
              <span style={{ fontSize: '18px', color: t.textMuted, marginLeft: 'auto' }}>→</span>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: '12px', color: t.textMuted, lineHeight: 1.4 }}>
                  Register, create your profile, manage appointments
                </p>
              </div>
              <span style={{ fontSize: '18px', color: t.textMuted, marginLeft: 'auto' }}>→</span>
            </motion.div>
          ...
          <p style={{ fontSize: '12px', color: t.textMuted, marginTop: '24px' }}>
            Already have an account?{' '}
            <span
  ...
  // ── Patient Form (existing code same) ────────────────────────
  return (
    <div style={{
      minHeight: '100vh',
      background: t.pageBg,
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'none', border: 'none',
                      cursor: 'pointer', fontSize: '13px', fontWeight: '600',
                      color: t.textMuted, lineHeight: 1, padding: 0,
                    }}
                  >
                    {showPassword ? 'Hide' : 'Show'}
                  </button>
